...
---
<!-- Vendored from skills.sh: vercel/next.js — skills/next-cache-components-optimizer/SKILL.md — synced 2026-07-17. Re-sync: npx skills add vercel/next.js --skill next-cache-components-optimizer -->
